export default {
  ...
  options: {
    ...
    guideOllamaStep1: "Unduh dan instal Ollama dari <strong>ollama.com/download</strong> (Windows / macOS / Linux).",
    ...
    guideLmstudioStep1: "Unduh LM Studio dari <strong>lmstudio.ai</strong>, instal dan buka aplikasinya.",
    ...
    guideLmstudioStep4: "Buka tab <strong>Local Server / Developer</strong>, pilih model yang sudah diunduh dari daftar di atas, klik <strong>Start Server</strong>. Server berjalan secara default di <code>http://127.0.0.1:1234</code>.",
