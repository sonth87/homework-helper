export default {
  general: {
    ...
    apiConfigLabelPlaceholder: "Nama panggilan (opsional)",
    apiConfigToggleDetails: "Tampilkan/sembunyikan detail",
  ...
  floatingPopup: {
    ...
    sourceGroupFree: "Layanan gratis",
    sourceGroupAi: "AI Anda",
    sourceAi: "Model AI (kunci / lokal)",
    translateFailed: "Gagal menerjemahkan. Coba layanan lain.",
    copied: "Tersalin!",
    retry: "Coba Lagi",
    ...
    translateHistoryTitle: "Riwayat terjemahan",
    translateHistoryTabHistory: "Riwayat",
    translateHistoryTabFavorite: "Favorit",
    translateHistoryClose: "Tutup",
    translateHistoryEmpty: "Belum ada terjemahan",
    translateHistoryEmptyFavorite: "Belum ada favorit",
    translateHistoryClear: "Hapus yang dipilih",
    translateHistoryConfirmClear: "Hapus {count} item yang dipilih? Tindakan ini tidak dapat dibatalkan.",
    translateHistoryDeleteAll: "Hapus semua",
    translateHistoryMoreDeleteOptions: "Opsi hapus lainnya",
    translateHistoryConfirmClearAll: "Hapus semua {count} item? Tindakan ini tidak dapat dibatalkan.",
    translateHistorySelectedCount: "{count} dipilih",
    favorite: "Favorit",
  },
  popup: {
    ...
    inputHint: "Enter untuk menerjemahkan · Shift+Enter untuk baris baru",
    ...
    widgetChatDesc: "Buka panel Obrolan AI untuk bertanya atau mengobrol bebas.",
    widgetCaptureDesc: "Pilih area layar (soal, rumus, grafik...) agar AI langsung membaca dan menyelesaikannya.",
    widgetHoverDesc: "Aktifkan/nonaktifkan fitur terjemahan saat kursor diarahkan ke teks di halaman web.",
    widgetSettingsDesc: "Buka halaman Pengaturan lengkap ekstensi.",
    formsAssistantDesc: "Mendeteksi pertanyaan di Google Forms secara otomatis dan menampilkan tombol «AI Selesaikan» di samping setiap pertanyaan.",
    selectionTooltipDesc: "Menampilkan bilah alat mengambang (Selesaikan, Salin, Terjemahkan...) setiap kali Anda memilih teks di halaman web.",
    autoClipboardDesc: "Saat popup ini dibuka, langsung menerjemahkan konten yang sudah ada di clipboard Anda.",
    hoverShortcutHeld: "Tahan",
    hoverShortcutNone: "Cukup arahkan kursor, tidak perlu menekan tombol",
    shortcutNotSet: "Belum ada pintasan yang ditetapkan — atur di chrome://extensions/shortcuts",
    shortcutsPanelTitle: "Pintasan Keyboard",
    rotationRandom: "Acak",
    rotationRoundRobin: "Round Robin",
    historyBtn: "Riwayat",
    historyTitle: "Riwayat terjemahan",
    historyTabHistory: "Riwayat",
    historyTabFavorite: "Favorit",
    historyClose: "Tutup",
    historyFavorite: "Favorit",
    historyEmpty: "Belum ada terjemahan",
    historyEmptyFavorite: "Belum ada favorit",
    historyClear: "Hapus yang dipilih",
    historyConfirmClear: "Hapus {count} item yang dipilih? Tindakan ini tidak dapat dibatalkan.",
    historyDeleteAll: "Hapus semua",
    historyMoreDeleteOptions: "Opsi hapus lainnya",
    historyConfirmClearAll: "Hapus semua {count} item? Tindakan ini tidak dapat dibatalkan.",
    historySelectedCount: "{count} dipilih",
  },
  options: {
    ...
    labelFabAutoHide: "Sembunyikan otomatis",
    labelFabAutoHideDesc: "Geser tombol mengambang ke tepi layar saat tidak digunakan, lalu tampil lagi saat kursor diarahkan ke sana. Nonaktifkan agar tombol selalu terlihat sepenuhnya.",
    ...
    hoverTranslateEnableTitle: "Aktifkan Terjemahan Cepat saat Arahkan Kursor",
    ...
    labelHoverHighlightColor: "Warna Sorotan",
    labelHoverHighlightColorDesc: "Warna yang digunakan untuk efek stabilo di atas.",
    labelHoverHighlightOpacity: "Intensitas Sorotan",
    labelHoverHighlightOpacityDesc: "Seberapa pekat warna sorotan di atas terlihat.",
    labelHoverHighlightStyle: "Gaya sorotan",
    labelHoverHighlightStyleDesc: "Cara teks yang sedang diterjemahkan ditandai.",
    hlStyleFill: "Isi penuh",
    hlStyleFillDesc: "Menutupi seluruh area teks dengan satu warna rata.",
    hlStyleUnderline: "Garis bawah",
    hlStyleUnderlineDesc: "Satu garis tipis di bawah teks.",
    hlStyleWavyUnderline: "Garis bawah bergelombang",
    hlStyleWavyUnderlineDesc: "Garis gelombang yang rata, seperti garis bawah pemeriksa ejaan.",
    hlStyleDoubleUnderline: "Garis bawah ganda",
    hlStyleDoubleUnderlineDesc: "Dua garis sejajar di bawah teks.",
    hlStyleMarker: "Stabilo alami",
    hlStyleMarkerDesc: "Pita transparan dengan tepi tidak rata, seperti stabilo asli.",
    hlStyleCircle: "Lingkaran gambar tangan",
    hlStyleCircleDesc: "Garis tepi oval yang tidak rata mengelilingi teks, tanpa warna isi.",
    hlStyleRectangle: "Persegi panjang gambar tangan",
    hlStyleRectangleDesc: "Garis tepi persegi panjang membulat dan sedikit tidak rata, tanpa warna isi.",
    hlStyleNaturalUnderline: "Garis bawah alami",
    ...
    toolbarThemeOptAuto: "Otomatis (mengikuti tema terang/gelap)",
    ...
    toolbarThemeOptRose: "Rose Pink (Merah Muda)",
    toolbarThemeOptAmber: "Amber Gold (Kuning Amber)",
    toolbarThemeOptIndigo: "Indigo Night (Nila)",
