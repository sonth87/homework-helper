export default {
  general: {
    ...
    welcomeText: 'Halo! Saya asisten Homework Helper. Soal PR apa yang ingin kita selesaikan hari ini?',
    ...
    modelNanoClick: 'Klik untuk melihat panduan aktivasi Gemini Nano di Pengaturan',
    modelAutoRotate: 'Rotasi Kunci Otomatis',
    emptyHistory: 'Belum ada riwayat percakapan tersimpan.<br>Mulai obrolan baru untuk memulai!',
    ...
    chips: [
      ...
      { label: 'Hukum Newton', query: 'Jelaskan 3 Hukum Gerak Newton beserta contoh nyata' },
      { label: 'Persamaan Kimia', query: 'Bagaimana cara menyetarakan persamaan reaksi kimia dan menghitung mol?' },
    ],
    modes: {
    ...
    copiedBtn: 'Tersalin!',
    retryBtn: 'Coba Lagi',
    imagePromptHeader: 'Tolong selesaikan dan jelaskan soal PR pada gambar ini langkah demi langkah dengan rumus LaTeX ($...$) dan tandai jawaban akhir:',
    chatCleared: 'Obrolan dibersihkan. Ajukan pertanyaan baru!',
    thinking: 'Sedang berpikir & menyelesaikan...',
    tooltips: {
      newChat: { title: 'Obrolan Baru', desc: 'Mulai sesi penyelesaian PR yang baru.' },
      history: { title: 'Riwayat Obrolan', desc: 'Lihat daftar percakapan soal yang tersimpan.' },
      lang: { title: 'Bahasa Respons AI', desc: 'AI akan menjawab dan menjelaskan menggunakan bahasa ini.' },
      mode: { title: 'Mode Penyelesaian', desc: 'Pilih format jawaban: Langkah demi Langkah, Langsung, Petunjuk, atau Teori Mendalam.' },
      capture: { title: 'Tangkapan Layar (Alt+C)', desc: 'Potong soal atau grafik di layar untuk langsung diselesaikan.' },
      upload: { title: 'Unggah Gambar', desc: 'Lampirkan file gambar soal dari komputer Anda.' },
      settings: { title: 'Model & Kunci API', desc: 'Atur penyedia AI dan kelola rotasi kunci API gratis.' },
      clear: { title: 'Bersihkan Obrolan', desc: 'Hapus semua pesan dalam sesi saat ini.' },
      options: { title: 'Pengaturan Lengkap', desc: 'Buka halaman konfigurasi untuk mengelola kunci API dan tampilan.' },
      close: { title: 'Tutup Panel', desc: 'Ciutkan panel ke tepi layar.' },
    },
  },
  selectionTooltip: {
    answer: 'Selesaikan',
  ...
  floatingPopup: {
    ...
    solvingStepByStep: 'Menyelesaikan langkah demi langkah dengan rumus KaTeX...',
  ...
  options: {
    ...
    subheadingProviders: 'Tambahkan satu atau lebih Kunci API. Ekstensi akan menyeimbangkan beban dan beralih otomatis saat batas limit tercapai.',
    strategyTitle: 'Strategi Rotasi Kunci',
    strategyDesc: 'Pilih metode pemilihan kunci saat mengirim permintaan ke AI.',
    ...
    subheadingOcr: 'Unduh dan kelola model pengenalan teks dan rumus offline via Tesseract.js.',
    btnCheckUpdates: 'Periksa Pembaruan',
    btnDownloadCore: 'Unduh Paket Utama (Bahasa Indonesia + Inggris + Matematika)',
    corePackTitle: 'Paket OCR Utama Bawaan',
    corePackBadge: 'Direkomendasikan',
    corePackDesc: 'Akurasi tinggi untuk karakter Latin, rumus matematika, Bahasa Indonesia, dan Inggris.',
    allOcrTitle: 'Semua Paket Bahasa',
    allOcrSub: 'Unduh paket bahasa khusus untuk pengenalan offline sesuai kebutuhan.',
    headingAppearance: 'Kustomisasi Tampilan & Antarmuka',
    subheadingAppearance: 'Atur tombol mengambang (FAB), bilah seleksi teks, tema warna, transparansi, dan blur.',
    cardFabTitle: 'Tombol Mengambang Halaman (FAB)',
    labelFabDisplay: 'Tampilkan tombol mengambang di web',
    descFabDisplay: 'Tampilkan tombol pintas di tepi layar untuk membuka obrolan atau tangkapan layar dengan cepat.',
    ...
    descToolbarText: 'Menampilkan nama tindakan (Selesaikan, Salin, Cari, Terjemahkan).',
    ...
    livePreviewSub: 'Pratinjau langsung gaya Liquid Glass sesuai pengaturan Anda.',
    headingGuide: 'Panduan Kunci API Gratis & Portal Resmi',
    subheadingGuide: 'Dapatkan Kunci API 100% resmi dan gratis dari penyedia AI terkemuka dengan kuota besar.',
    guideWhyTitle: 'Mengapa sebaiknya menambahkan banyak Kunci API?',
    guideWhy1: 'Pengalihan Otomatis: Jika satu kunci mencapai batas (429), sistem langsung beralih ke kunci berikutnya.',
    guideWhy2: 'Penyeimbangan Beban: Membagi permintaan secara merata untuk menghindari pembatasan kuota.',
    guideWhy3: 'Hemat Biaya: Menggabungkan kuota gratis dari berbagai penyedia cloud.',
    guideHowTitle: 'Bagaimana cara kerjanya?',
    guideHow1: 'Dapatkan kunci gratis dari portal resmi (Google AI Studio, Groq, OpenRouter...).',
    ...
    linkSubGemini: 'Gratis 15 RPM, inferensi super cepat dan analisis gambar soal yang sangat kuat.',
    linkSubGroq: 'Kecepatan inferensi tinggi (500+ token/dtk), mendukung Llama 3 & DeepSeek.',
    linkSubOpenAI: 'Standar industri untuk penalaran logis dan akademis.',
    linkSubDeepSeek: 'Model terdepan untuk matematika dan pemrograman sumber terbuka.',
    linkSubClaude: 'Pemahaman diagram ilmiah dan penyampaian logika yang sangat jelas.',
    headingPrompt: 'Instruksi Sistem & Gaya Penyelesaian Soal',
    subheadingPrompt: 'Sesuaikan cara mengajar AI, format rumus, dan kedalaman penjelasan langkah demi langkah.',
    btnResetPrompt: 'Kembalikan ke Default',
    btnSavePrompt: 'Simpan Instruksi',
    headingGeneral: 'Pengaturan Umum & Bahasa',
    subheadingGeneral: 'Kelola bahasa respons, asisten Google Forms, dan pencadangan data.',
    uiLangTitle: 'Bahasa Antarmuka (UI Language)',
    uiLangDesc: 'Bahasa tampilan untuk tombol, bilah samping, toolbar, dan menu pengaturan.',
    respLangTitle: 'Bahasa Respons AI',
    respLangDesc: 'Bahasa yang digunakan AI untuk menyelesaikan dan menjelaskan soal.',
    formsTitle: 'Asisten Google Forms',
    formsDesc: 'Mendeteksi pertanyaan di Google Forms secara otomatis dan menyediakan tombol analisis satu klik.',
    tooltipTitle: 'Bilah Mengambang Seleksi Teks',
    tooltipDesc: 'Tampilkan bilah tindakan cepat saat Anda menyeleksi teks di halaman web.',
    disabledSitesTitle: 'Daftar Situs Web yang Dinonaktifkan',
    disabledSitesDesc: 'Ekstensi akan sepenuhnya nonaktif pada domain-domain ini.',
    noDisabledSites: 'Belum ada situs web yang dinonaktifkan.',
    backupTitle: 'Pencadangan & Pengelolaan Data',
    backupDesc: 'Ekspor konfigurasi ke file JSON atau bersihkan riwayat percakapan tersimpan.',
    btnExport: 'Ekspor Konfigurasi JSON',
    btnClearData: 'Hapus Semua Riwayat Obrolan',
    aboutTitle: 'Tentang & Informasi Ekstensi',
    aboutDesc: 'Homework Helper - Asisten AI untuk menyelesaikan tugas sekolah dan studi akademis.',
