export default {
  general: {
    ...
    welcomeText: 'Olá! Sou seu assistente Homework Helper. Qual tarefa resolveremos hoje?',
    newChat: 'Novo chat',
    ...
    emptyHistory: 'Nenhum histórico salvo.<br>Inicie um novo chat para começar!',
    loadingHistory: 'Carregando histórico...',
    chips: [
      { label: 'Equação quadrática', query: 'Resolva a equação quadrática ax^2 + bx + c = 0 passo a passo' },
      { label: 'Leis de Newton', query: 'Explique as 3 leis do movimento de Newton com exemplos práticos' },
      { label: 'Equação química', query: 'Como balancear equações químicas e calcular proporções molares?' },
    ],
    modes: {
    ...
    imagePromptHeader: 'Por favor, resolva e explique esta questão da imagem passo a passo com fórmulas LaTeX ($...$) e destaque a resposta final:',
    chatCleared: 'Chat limpo. Faça uma nova pergunta!',
    thinking: 'Pensando e resolvendo...',
    tooltips: {
      newChat: { title: 'Novo chat', desc: 'Inicie uma nova sessão de estudos.' },
      history: { title: 'Histórico', desc: 'Veja soluções de tarefas anteriores.' },
      lang: { title: 'Idioma de resposta', desc: 'A IA responderá e explicará neste idioma.' },
      mode: { title: 'Modo de resolução', desc: 'Formato: Passo a passo, Direto, Dicas ou Teoria profunda.' },
      capture: { title: 'Captura de tela (Alt+C)', desc: 'Recorte uma questão na tela para resolvê-la instantaneamente.' },
      upload: { title: 'Enviar imagem', desc: 'Anexe uma imagem do seu computador.' },
      settings: { title: 'Modelos e chaves API', desc: 'Gerencie provedores e rotação de chaves gratuitas.' },
      clear: { title: 'Limpar chat', desc: 'Exclui todas as mensagens da sessão atual.' },
      options: { title: 'Configurações completas', desc: 'Abra a página de configurações de chaves e aparência.' },
      close: { title: 'Fechar painel', desc: 'Recolhe o painel para a lateral da tela.' },
    },
  },
  selectionTooltip: {
    answer: 'Resolver',
  ...
  options: {
    ...
    subheadingProviders: 'Adicione uma ou mais chaves API. A extensão balanceia a carga e alterna automaticamente para chaves reservas.',
    strategyTitle: 'Estratégia de rotação',
    strategyDesc: 'Escolha como as chaves ativas são selecionadas nas solicitações.',
    ...
    subheadingOcr: 'Baixe modelos de reconhecimento offline para fórmulas e texto via Tesseract.js.',
    btnCheckUpdates: 'Verificar atualizações',
    btnDownloadCore: 'Baixar pacote principal (Português + Inglês + Matemática)',
    corePackTitle: 'Pacote OCR principal integrado',
    corePackBadge: 'Recomendado',
    corePackDesc: 'Alta precisão para caracteres latinos, fórmulas matemáticas, português e inglês.',
    allOcrTitle: 'Todos os pacotes de idiomas',
    allOcrSub: 'Baixe pacotes específicos para reconhecimento offline conforme necessário.',
    headingAppearance: 'Personalização visual e de interface',
    subheadingAppearance: 'Personalize os botões flutuantes (FAB), barra de seleção, temas, transparência e desfoque.',
    cardFabTitle: 'Botões flutuantes na página (FAB)',
    labelFabDisplay: 'Exibir botões flutuantes nas páginas',
    descFabDisplay: 'Mostra botões rápidos na borda da tela para abrir o chat ou capturar questões.',
    ...
    descToolbarText: 'Exibe nomes das ações (Resolver, Copiar, Buscar, Traduzir).',
    ...
    livePreviewSub: 'Visualização instantânea do estilo Liquid Glass com seus ajustes.',
    headingGuide: 'Guia de chaves API gratuitas e portais oficiais',
    subheadingGuide: 'Chaves 100% oficiais e gratuitas dos principais provedores com cotas generosas.',
    guideWhyTitle: 'Por que adicionar múltiplas chaves API?',
    guideWhy1: 'Failover automático: Se uma chave atingir o limite (429), o sistema muda para a próxima imediatamente.',
    guideWhy2: 'Balanceamento de carga: Distribui as requisições uniformemente para evitar limites.',
    guideWhy3: 'Sem custos: Combine cotas gratuitas de diversos provedores na nuvem.',
    guideHowTitle: 'Como funciona?',
    guideHow1: 'Obtenha chaves gratuitas nos portais oficiais (Google AI Studio, Groq, OpenRouter...).',
    guideHow2: 'Cole na aba "Modelos e chaves API" e clique em testar conexão.',
    guideHow3: 'A extensão gerencia a rotação em segundo plano automaticamente.',
    guideLinksTitle: 'Portais oficiais de chaves gratuitas',
    linkSubGemini: '15 RPM grátis, velocidade ultrarrápida e excelente análise visual de questões.',
    linkSubGroq: 'Inferência ultraveloz (500+ tokens/s), compatível com Llama 3 e DeepSeek.',
    ...
    headingPrompt: 'Instruções do sistema e estilo de resolução',
    subheadingPrompt: 'Personalize a pedagogia da IA, formatação de fórmulas e profundidade dos passos.',
    btnResetPrompt: 'Restaurar padrão',
    btnSavePrompt: 'Salvar instruções',
    headingGeneral: 'Configurações gerais e idioma',
    subheadingGeneral: 'Gerencie idioma de resposta, assistente Google Forms e backups.',
    uiLangTitle: 'Idioma da interface (UI Language)',
    uiLangDesc: 'Idioma exibido em todos os botões, barra lateral e configurações.',
    ...
    formsDesc: 'Detecta questões no Google Forms e oferece botão de análise em um clique.',
    tooltipTitle: 'Barra flutuante de seleção de texto',
    tooltipDesc: 'Exibe a barra de ações ao selecionar qualquer texto na página.',
    ...
    backupDesc: 'Exporte a configuração em JSON ou limpe o histórico de conversas salvo.',
    btnExport: 'Exportar configuração JSON',
    btnClearData: 'Limpar todo o histórico de chat',
    aboutTitle: 'Sobre e informações',
    aboutDesc: 'Homework Helper - Assistente de IA para resolução de tarefas e estudo acadêmico.',
