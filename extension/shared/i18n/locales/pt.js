export default {
  ...
  options: {
    ...
    guideOllamaStep1: "Baixe e instale o Ollama em <strong>ollama.com/download</strong> (Windows / macOS / Linux).",
    ...
    guideLmstudioStep1: "Baixe o LM Studio em <strong>lmstudio.ai</strong>, instale e abra o app.",
    ...
    guideLmstudioStep4: "Vá para a aba <strong>Local Server / Developer</strong>, selecione o modelo baixado na lista acima, clique em <strong>Start Server</strong>. O servidor roda por padrão em <code>http://127.0.0.1:1234</code>.",
