export default {
  ...
  options: {
    ...
    guideOllamaStep1: "Téléchargez et installez Ollama depuis <strong>ollama.com/download</strong> (Windows / macOS / Linux).",
    ...
    guideLmstudioStep1: "Téléchargez LM Studio depuis <strong>lmstudio.ai</strong>, installez et ouvrez l'application.",
    ...
    guideLmstudioStep4: "Allez dans l'onglet <strong>Local Server / Developer</strong>, sélectionnez le modèle téléchargé dans la liste ci-dessus, cliquez sur <strong>Start Server</strong>. Le serveur s'exécute par défaut sur <code>http://127.0.0.1:1234</code>.",
