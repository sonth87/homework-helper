export default {
  general: {
    ...
    modelNanoClick: 'Нажмите, чтобы открыть руководство по активации Gemini Nano',
    modelAutoRotate: 'Авторотация ключей',
    emptyHistory: 'Нет сохраненных диалогов.<br>Начните новый чат для решения задач!',
    loadingHistory: 'Загрузка истории...',
    chips: [
      { label: 'Квадратное уравнение', query: 'Реши квадратное уравнение ax^2 + bx + c = 0 пошагово' },
      { label: 'Законы Ньютона', query: 'Объясни 3 закона движения Ньютона с реальными примерами' },
      { label: 'Химическое уравнение', query: 'Как уравнивать химические реакции и рассчитывать моли?' },
    ],
    modes: {
    ...
    retryBtn: 'Повторить',
    imagePromptHeader: 'Пожалуйста, решите и объясните это задание с изображения пошагово с формулами LaTeX ($...$) и выделите ответ:',
    chatCleared: 'Чат очищен. Задайте новый вопрос!',
    thinking: 'Думаю & решаю...',
    tooltips: {
      newChat: { title: 'Новый чат', desc: 'Начать новую сессию решения задач.' },
      history: { title: 'История', desc: 'Просмотреть сохраненные решения.' },
      lang: { title: 'Язык ответа ИИ', desc: 'ИИ будет отвечать и объяснять на этом языке.' },
      mode: { title: 'Режим решения', desc: 'Формат: Пошагово, Прямой ответ, Подсказка или Теория.' },
      capture: { title: 'Снимок экрана (Alt+C)', desc: 'Выделите задачу или график на экране для мгновенного решения.' },
      upload: { title: 'Загрузить картинку', desc: 'Прикрепите изображение задачи с компьютера.' },
      settings: { title: 'Модели и ключи API', desc: 'Управление провайдерами ИИ и автобалансировкой ключей.' },
      clear: { title: 'Очистить чат', desc: 'Удалить все сообщения текущей сессии.' },
      options: { title: 'Полные настройки', desc: 'Открыть страницу управления API-ключами и кастомизации интерфейса.' },
      close: { title: 'Закрыть панель', desc: 'Свернуть панель к краю экрана.' },
    },
  },
  selectionTooltip: {
    answer: 'Решить',
  ...
  options: {
    ...
    subheadingProviders: 'Добавьте один или несколько API-ключей. Расширение распределяет нагрузку и переключается на резервные ключи при лимитах.',
    strategyTitle: 'Стратегия ротации ключей',
    strategyDesc: 'Выберите метод распределения активных ключей при отправке запросов.',
    ...
    subheadingOcr: 'Загружайте офлайн-модели распознавания текста и формул через Tesseract.js.',
    btnCheckUpdates: 'Проверить обновления',
    btnDownloadCore: 'Скачать базовый пакет (Русский + Английский + Математика)',
    corePackTitle: 'Встроенный базовый пакет OCR',
    corePackBadge: 'Рекомендуется',
    corePackDesc: 'Высокая точность для латиницы, кириллицы, формул и английского языка.',
    allOcrTitle: 'Все языковые пакеты',
    allOcrSub: 'Загружайте специальные офлайн-пакеты языков по мере необходимости.',
    headingAppearance: 'Настройка внешнего вида и интерфейса',
    subheadingAppearance: 'Настройте плавающие кнопки (FAB), панель выделения, темы, прозрачность и размытие.',
    cardFabTitle: 'Плавающие кнопки на странице (FAB)',
    labelFabDisplay: 'Показывать кнопки на веб-страницах',
    descFabDisplay: 'Отображает быстрые кнопки у края экрана для открытия чата и скриншотов.',
    ...
    descToolbarText: 'Отображать названия действий (Решить, Копировать, Поиск, Перевод).',
    ...
    livePreviewSub: 'Мгновенный предпросмотр стиля Liquid Glass с вашими параметрами.',
    headingGuide: 'Гайд по бесплатным API-ключам и порталам',
    subheadingGuide: '100% официальные бесплатные ключи от ведущих ИИ-провайдеров с большими квотами.',
    guideWhyTitle: 'Зачем добавлять несколько API-ключей?',
    guideWhy1: 'Автопереключение: Если ключ исчерпал лимит (429), система сразу переходит к следующему.',
    guideWhy2: 'Балансировка нагрузки: Равномерно распределяет запросы во избежание ограничений.',
    guideWhy3: 'Без затрат: Объединяйте бесплатные квоты различных облачных сервисов.',
    guideHowTitle: 'Как это работает?',
    guideHow1: 'Получите бесплатные ключи на официальных порталах (Google AI Studio, Groq, OpenRouter...).',
    guideHow2: 'Вставьте их во вкладку «Модели и ключи API» и протестируйте подключение.',
    ...
    linkSubGemini: 'Бесплатно 15 RPM, сверхбыстрая скорость и отличный разбор изображений задач.',
    linkSubGroq: 'Рекордная скорость (500+ токенов/с), поддержка Llama 3 и DeepSeek.',
    ...
    linkSubClaude: 'Превосходное понимание диаграмм и понятное пошаговое объяснение.',
    headingPrompt: 'Системные инструкции и стиль решения',
    subheadingPrompt: 'Настройте педагогический стиль ИИ, формат формул и глубину шагов.',
    btnResetPrompt: 'Сбросить по умолчанию',
    btnSavePrompt: 'Сохранить инструкции',
    headingGeneral: 'Общие настройки и язык',
    subheadingGeneral: 'Управление языком ответов, помощником Google Forms и резервным копированием.',
    ...
    formsDesc: 'Автоматически определяет вопросы в Google Forms и добавляет кнопку решения в один клик.',
    tooltipTitle: 'Плавающая панель выделения текста',
    tooltipDesc: 'Показывает панель действий при выделении текста на любой странице.',
    ...
    backupDesc: 'Экспорт конфигурации в JSON или очистка сохраненной истории чатов.',
    btnExport: 'Экспорт JSON конфигурации',
    btnClearData: 'Очистить всю историю чатов',
    aboutTitle: 'О расширении',
    aboutDesc: 'Homework Helper - Умный ИИ-помощник для решения домашних заданий и учебы.',
