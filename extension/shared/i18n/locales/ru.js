export default {
  ...
  options: {
    ...
    guideOllamaStep1: "Скачайте и установите Ollama с сайта <strong>ollama.com/download</strong> (Windows / macOS / Linux).",
    ...
    guideLmstudioStep1: "Скачайте LM Studio с сайта <strong>lmstudio.ai</strong>, установите и откройте приложение.",
    ...
    guideLmstudioStep4: "Перейдите на вкладку <strong>Local Server / Developer</strong>, выберите скачанную модель из списка выше, нажмите <strong>Start Server</strong>. По умолчанию сервер работает по адресу <code>http://127.0.0.1:1234</code>.",
