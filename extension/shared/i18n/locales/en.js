export default {
  ...
  options: {
    ...
    labelLiquidGlassScaleDesc: "How much the backdrop behind the glass bends — higher means stronger waviness.",
    labelLiquidGlassFrequency: "Noise Frequency",
    labelLiquidGlassFrequencyDesc: "How fine or coarse the noise pattern on the glass is — lower gives large smooth streaks, higher gives dense small ripples.",
