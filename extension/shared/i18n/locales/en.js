export default {
  ...
  options: {
    ...
    guideOllamaStep1: "Download and install Ollama from <strong>ollama.com/download</strong> (Windows / macOS / Linux).",
    ...
    guideLmstudioStep1: "Download LM Studio from <strong>lmstudio.ai</strong>, install and open the app.",
    ...
    guideLmstudioStep4: "Go to the <strong>Local Server / Developer</strong> tab, select the downloaded model from the list above, click <strong>Start Server</strong>. The server runs by default at <code>http://127.0.0.1:1234</code>.",
