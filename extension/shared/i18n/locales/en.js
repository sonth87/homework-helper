export default {
  general: {
    ...
    apiConfigLabelPlaceholder: "Nickname (optional)",
    apiConfigToggleDetails: "Show/hide details",
  ...
  options: {
    ...
    labelLiquidGlassScale: "Distortion (Scale)",
    labelLiquidGlassScaleDesc: "How strongly the backdrop behind the glass refracts — more negative means a stronger bulge, toward 0 turns it off.",
    labelLiquidGlassChroma: "Chroma (Edge Fringe)",
    labelLiquidGlassChromaDesc: "Color separation at the refracted edge — 0 disables the rainbow-fringe look, higher makes it more visible.",
    ...
    labelFabAutoHide: "Auto-hide",
    labelFabAutoHideDesc: "Slide the floating buttons into the screen edge when idle, revealed again on hover. Turn off to keep them fully visible at all times.",
    ...
    labelHoverHighlightStyle: "Highlight style",
    labelHoverHighlightStyleDesc: "How the translated text gets marked.",
    hlStyleFill: "Fill",
    hlStyleFillDesc: "Covers the whole text area with a flat block of color.",
    hlStyleUnderline: "Underline",
    hlStyleUnderlineDesc: "A single thin line below the text.",
    hlStyleWavyUnderline: "Wavy underline",
    hlStyleWavyUnderlineDesc: "An even wave line below the text, like a spell-checker squiggle.",
    hlStyleDoubleUnderline: "Double underline",
    hlStyleDoubleUnderlineDesc: "Two parallel lines below the text.",
    hlStyleMarker: "Natural highlighter",
    hlStyleMarkerDesc: "A translucent wash with rough, uneven edges, like a real highlighter pen.",
    hlStyleCircle: "Hand-drawn circle",
    hlStyleCircleDesc: "A wobbly oval outline around the text, no fill.",
    hlStyleRectangle: "Hand-drawn rectangle",
    hlStyleRectangleDesc: "A rounded, slightly uneven rectangle outline, no fill.",
    hlStyleNaturalUnderline: "Natural underline",
