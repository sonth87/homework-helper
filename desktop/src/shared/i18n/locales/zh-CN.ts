...
export default {
  ...
  resultCopy: '复制',
  excludedAppsAdd: '添加',
  excludedAppsPlaceholder: '应用名称，例如 1Password',
  excludedAppsEmpty: '尚未排除任何应用。',
  setPerformanceMode: '性能模式',
  setPerformanceModeDesc: '在读取没有直接可访问文本的屏幕内容（PDF、图片、自定义编辑器）时，在速度和 OCR 准确度之间取舍。',
  perfFast: '快速',
  perfBalanced: '平衡',
  perfAccurate: '精确',
  groupDiagnostics: '诊断',
  diagPlatform: '平台',
  diagVersion: '应用版本',
  diagAccessibility: '辅助功能权限',
  diagScreenRecording: '屏幕录制权限',
  diagAccessibilityProvider: '屏幕内容读取',
  diagOcrProvider: '系统原生 OCR',
  diagHoverTranslate: '悬停翻译',
  diagClipboardWatcher: '剪贴板监听',
  diagAiProviders: '已启用的 AI 提供商',
  diagTranslateProviders: '已启用的翻译服务',
  diagDebugTitle: '调试工具',
  diagDebugDesc: '用于更深入的自我诊断，或附加到错误报告中。',
  diagBtnLoadLogs: '加载最近日志',
  diagLogsEmpty: '暂无日志。',
  diagLogLevel: '日志级别',
  diagLogLevelHint: '立即生效，下次启动应用时恢复默认值。',
  logLevelError: '错误',
  logLevelWarn: '警告',
  logLevelInfo: '信息',
  logLevelDebug: '调试',
  logLevelTrace: '详细',
  diagBtnClearCaches: '清除 OCR 缓存 + 翻译冷却',
  diagClearCachesHint: '强制下一次悬停重新识别，并立即重试每个翻译服务。',
  diagClearCachesDone: '已清除。',
  diagBtnExportBundle: '导出调试包',
  diagExportBundleHint: '将诊断信息、设置和最近日志保存到文件——绝不包含 API 密钥。',
  diagExportBundleDone: '已保存至：',
  diagExportBundleCanceled: '已取消。',
  diagExportDialogTitle: '导出调试包',
