...
export default {
  ...
  resultStop: 'Dừng',
  resultCopy: 'Sao chép',
  excludedAppsAdd: 'Thêm',
  excludedAppsPlaceholder: 'Tên ứng dụng, ví dụ: 1Password',
  excludedAppsEmpty: 'Chưa loại trừ ứng dụng nào.',
  setPerformanceMode: 'Chế độ hiệu năng',
  setPerformanceModeDesc: 'Đánh đổi giữa tốc độ và độ chính xác OCR khi đọc nội dung màn hình không có text truy cập trực tiếp (PDF, ảnh, trình soạn thảo tuỳ biến).',
  perfFast: 'Nhanh',
  perfBalanced: 'Cân bằng',
  perfAccurate: 'Chính xác',
  groupDiagnostics: 'Chẩn đoán',
  diagPlatform: 'Nền tảng',
  diagVersion: 'Phiên bản ứng dụng',
  diagAccessibility: 'Quyền Accessibility',
  diagScreenRecording: 'Quyền Ghi màn hình',
  diagAccessibilityProvider: 'Đọc nội dung màn hình',
  diagOcrProvider: 'OCR native',
  diagHoverTranslate: 'Dịch khi rê chuột',
  diagClipboardWatcher: 'Theo dõi clipboard',
  diagAiProviders: 'Nhà cung cấp AI đã bật',
  diagTranslateProviders: 'Dịch vụ dịch đã bật',
  diagDebugTitle: 'Công cụ debug',
  diagDebugDesc: 'Dùng khi cần tự chẩn đoán sâu hơn, hoặc để đính kèm khi báo lỗi.',
  diagBtnLoadLogs: 'Xem log gần đây',
  diagLogsEmpty: 'Chưa có log nào.',
  diagLogLevel: 'Mức log',
  diagLogLevelHint: 'Áp dụng ngay, tự về mặc định ở lần khởi động app kế tiếp.',
  logLevelError: 'Lỗi',
  logLevelWarn: 'Cảnh báo',
  logLevelInfo: 'Thông tin',
  logLevelDebug: 'Debug',
  logLevelTrace: 'Chi tiết',
  diagBtnClearCaches: 'Xoá cache OCR + cooldown dịch',
  diagClearCachesHint: 'Buộc lần rê chuột kế tiếp nhận dạng lại từ đầu và thử lại ngay mọi dịch vụ dịch.',
  diagClearCachesDone: 'Đã xoá.',
  diagBtnExportBundle: 'Xuất gói debug',
  diagExportBundleHint: 'Lưu thông tin chẩn đoán, cấu hình và log gần đây ra file — không bao giờ kèm API key.',
