...
export default {
  ...
  diagDebugTitle: 'Debug-Werkzeuge',
  diagDebugDesc: 'Für eine tiefergehende Selbstdiagnose oder zum Anhängen an einen Fehlerbericht.',
  diagBtnLoadLogs: 'Letzte Protokolle laden',
  diagLogsEmpty: 'Noch keine Protokolle.',
  diagLogLevel: 'Protokollstufe',
  diagLogLevelHint: 'Wirkt sofort, wird beim nächsten App-Start auf den Standard zurückgesetzt.',
  logLevelError: 'Fehler',
  logLevelWarn: 'Warnung',
  logLevelInfo: 'Info',
  logLevelDebug: 'Debug',
  logLevelTrace: 'Ausführlich',
  diagBtnClearCaches: 'OCR-Cache + Übersetzungs-Cooldowns löschen',
  diagClearCachesHint: 'Erzwingt, dass beim nächsten Hover die Erkennung neu läuft und jeder Übersetzungsdienst sofort erneut versucht wird.',
  diagClearCachesDone: 'Gelöscht.',
  diagBtnExportBundle: 'Debug-Paket exportieren',
  diagExportBundleHint: 'Speichert Diagnose, Einstellungen und letzte Protokolle in einer Datei — enthält niemals API-Schlüssel.',
