...
export default {
  ...
  excludedAppsAdd: 'Добавить',
  excludedAppsPlaceholder: 'Название приложения, напр. 1Password',
  excludedAppsEmpty: 'Пока нет исключённых приложений.',
  setPerformanceMode: 'Режим производительности',
  setPerformanceModeDesc: 'Компромисс между скоростью и точностью OCR при чтении содержимого экрана без напрямую доступного текста (PDF, изображения, нестандартные редакторы).',
  perfFast: 'Быстрый',
  perfBalanced: 'Сбалансированный',
  perfAccurate: 'Точный',
  groupDiagnostics: 'Диагностика',
  diagPlatform: 'Платформа',
  diagVersion: 'Версия приложения',
  diagAccessibility: 'Разрешение специальных возможностей',
  diagScreenRecording: 'Разрешение записи экрана',
  diagAccessibilityProvider: 'Чтение содержимого экрана',
  diagOcrProvider: 'Встроенный OCR',
  diagHoverTranslate: 'Перевод при наведении',
  diagClipboardWatcher: 'Отслеживание буфера обмена',
  diagAiProviders: 'Включённые провайдеры ИИ',
  diagTranslateProviders: 'Включённые сервисы перевода',
  diagDebugTitle: 'Инструменты отладки',
  diagDebugDesc: 'Для более глубокой самодиагностики или чтобы приложить к отчёту об ошибке.',
  diagBtnLoadLogs: 'Загрузить последние логи',
  diagLogsEmpty: 'Логов пока нет.',
  diagLogLevel: 'Уровень логирования',
  diagLogLevelHint: 'Применяется сразу, при следующем запуске приложения вернётся к значению по умолчанию.',
  logLevelError: 'Ошибка',
  logLevelWarn: 'Предупреждение',
  logLevelInfo: 'Информация',
  logLevelDebug: 'Отладка',
  logLevelTrace: 'Подробно',
  diagBtnClearCaches: 'Очистить кэш OCR + задержки перевода',
  diagClearCachesHint: 'Заставляет следующее наведение курсора заново распознать текст и сразу повторить попытку для каждого сервиса перевода.',
  diagClearCachesDone: 'Очищено.',
  diagBtnExportBundle: 'Экспортировать отладочный пакет',
  diagExportBundleHint: 'Сохраняет диагностику, настройки и последние логи в файл — никогда не включает API-ключи.',
