...
export default {
  ...
  diagDebugTitle: 'デバッグツール',
  diagDebugDesc: 'より詳しい自己診断や、不具合報告への添付に使用します。',
  diagBtnLoadLogs: '最近のログを読み込む',
  diagLogsEmpty: 'ログはまだありません。',
  diagLogLevel: 'ログレベル',
  diagLogLevelHint: '即座に反映され、次回起動時に既定値へ戻ります。',
  logLevelError: 'エラー',
  logLevelWarn: '警告',
  logLevelInfo: '情報',
  logLevelDebug: 'デバッグ',
  logLevelTrace: '詳細',
  diagBtnClearCaches: 'OCRキャッシュ + 翻訳クールダウンを消去',
  diagClearCachesHint: '次のホバーで認識をやり直し、すべての翻訳サービスをすぐに再試行します。',
  diagClearCachesDone: '消去しました。',
  diagBtnExportBundle: 'デバッグ情報を書き出す',
  diagExportBundleHint: '診断情報・設定・最近のログをファイルに保存します — APIキーは含みません。',
