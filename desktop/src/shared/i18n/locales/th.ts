...
export default {
  ...
  resultStop: 'หยุด',
  resultCopy: 'คัดลอก',
  excludedAppsAdd: 'เพิ่ม',
  excludedAppsPlaceholder: 'ชื่อแอป เช่น 1Password',
  excludedAppsEmpty: 'ยังไม่มีแอปที่ถูกยกเว้น',
  setPerformanceMode: 'โหมดประสิทธิภาพ',
  setPerformanceModeDesc: 'แลกเปลี่ยนระหว่างความเร็วและความแม่นยำของ OCR เมื่ออ่านเนื้อหาบนหน้าจอที่ไม่มีข้อความเข้าถึงได้โดยตรง (PDF ภาพ ตัวแก้ไขแบบกำหนดเอง)',
  perfFast: 'เร็ว',
  perfBalanced: 'สมดุล',
  perfAccurate: 'แม่นยำ',
  groupDiagnostics: 'การวินิจฉัย',
  diagPlatform: 'แพลตฟอร์ม',
  diagVersion: 'เวอร์ชันแอป',
  diagAccessibility: 'สิทธิ์การช่วยการเข้าถึง',
  diagScreenRecording: 'สิทธิ์บันทึกหน้าจอ',
  diagAccessibilityProvider: 'การอ่านเนื้อหาหน้าจอ',
  diagOcrProvider: 'OCR ของระบบ',
  diagHoverTranslate: 'แปลเมื่อชี้เมาส์',
  diagClipboardWatcher: 'การติดตามคลิปบอร์ด',
  diagAiProviders: 'ผู้ให้บริการ AI ที่เปิดใช้งาน',
  diagTranslateProviders: 'บริการแปลที่เปิดใช้งาน',
  diagDebugTitle: 'เครื่องมือดีบัก',
  diagDebugDesc: 'สำหรับการวินิจฉัยด้วยตนเองเชิงลึก หรือแนบไปกับรายงานข้อผิดพลาด',
  diagBtnLoadLogs: 'โหลดล็อกล่าสุด',
  diagLogsEmpty: 'ยังไม่มีล็อก',
  diagLogLevel: 'ระดับล็อก',
  diagLogLevelHint: 'มีผลทันที และจะกลับเป็นค่าเริ่มต้นเมื่อเปิดแอปครั้งถัดไป',
  logLevelError: 'ข้อผิดพลาด',
  logLevelWarn: 'คำเตือน',
  logLevelInfo: 'ข้อมูล',
  logLevelDebug: 'ดีบัก',
  logLevelTrace: 'รายละเอียด',
  diagBtnClearCaches: 'ล้างแคช OCR + คูลดาวน์การแปล',
  diagClearCachesHint: 'บังคับให้การชี้เมาส์ครั้งถัดไปรู้จำใหม่ทั้งหมดและลองบริการแปลทุกตัวใหม่ทันที',
  diagClearCachesDone: 'ล้างแล้ว',
  diagBtnExportBundle: 'ส่งออกชุดข้อมูลดีบัก',
  diagExportBundleHint: 'บันทึกข้อมูลวินิจฉัย การตั้งค่า และล็อกล่าสุดลงไฟล์ — ไม่รวม API key เด็ดขาด',
