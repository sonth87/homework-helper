...
export default {
  ...
  resultStop: 'Detener',
  resultCopy: 'Copiar',
  excludedAppsAdd: 'Añadir',
  excludedAppsPlaceholder: 'Nombre de la app, p. ej. 1Password',
  excludedAppsEmpty: 'Aún no hay apps excluidas.',
  setPerformanceMode: 'Modo de rendimiento',
  setPerformanceModeDesc: 'Equilibrio entre velocidad y precisión de OCR al leer contenido de pantalla sin texto accesible directo (PDF, imágenes, editores personalizados).',
  perfFast: 'Rápido',
  perfBalanced: 'Equilibrado',
  perfAccurate: 'Preciso',
  groupDiagnostics: 'Diagnóstico',
  diagPlatform: 'Plataforma',
  diagVersion: 'Versión de la app',
  diagAccessibility: 'Permiso de accesibilidad',
  diagScreenRecording: 'Permiso de grabación de pantalla',
  diagAccessibilityProvider: 'Lectura de contenido en pantalla',
  diagOcrProvider: 'OCR nativo',
  diagHoverTranslate: 'Traducción al pasar el cursor',
  diagClipboardWatcher: 'Monitor del portapapeles',
  diagAiProviders: 'Proveedores de IA habilitados',
  diagTranslateProviders: 'Servicios de traducción habilitados',
  diagDebugTitle: 'Herramientas de depuración',
  diagDebugDesc: 'Para autodiagnóstico más profundo, o para adjuntar a un reporte de error.',
  diagBtnLoadLogs: 'Cargar registros recientes',
  diagLogsEmpty: 'Aún no hay registros.',
  diagLogLevel: 'Nivel de registro',
  diagLogLevelHint: 'Se aplica de inmediato; vuelve al valor predeterminado en el próximo inicio de la app.',
  logLevelError: 'Error',
  logLevelWarn: 'Advertencia',
  logLevelInfo: 'Información',
  logLevelDebug: 'Depuración',
  logLevelTrace: 'Detallado',
  diagBtnClearCaches: 'Borrar caché de OCR + tiempos de espera de traducción',
  diagClearCachesHint: 'Obliga a que el próximo paso del cursor vuelva a reconocer el texto y reintente cada servicio de traducción de inmediato.',
  diagClearCachesDone: 'Borrado.',
  diagBtnExportBundle: 'Exportar paquete de depuración',
  diagExportBundleHint: 'Guarda diagnóstico, configuración y registros recientes en un archivo — nunca incluye claves de API.',
  diagExportBundleDone: 'Guardado en:',
  diagExportBundleCanceled: 'Cancelado.',
  diagExportDialogTitle: 'Exportar paquete de depuración',
