...
export default {
  ...
  resultCopy: '복사',
  excludedAppsAdd: '추가',
  excludedAppsPlaceholder: '앱 이름, 예: 1Password',
  excludedAppsEmpty: '제외된 앱이 아직 없습니다.',
  setPerformanceMode: '성능 모드',
  setPerformanceModeDesc: '직접 접근 가능한 텍스트가 없는 화면 콘텐츠(PDF, 이미지, 커스텀 에디터)를 읽을 때 속도와 OCR 정확도 사이의 균형을 조정합니다.',
  perfFast: '빠름',
  perfBalanced: '균형',
  perfAccurate: '정확',
  groupDiagnostics: '진단',
  diagPlatform: '플랫폼',
  diagVersion: '앱 버전',
  diagAccessibility: '손쉬운 사용 권한',
  diagScreenRecording: '화면 기록 권한',
  diagAccessibilityProvider: '화면 내용 읽기',
  diagOcrProvider: '네이티브 OCR',
  diagHoverTranslate: '호버 번역',
  diagClipboardWatcher: '클립보드 감시',
  diagAiProviders: '활성화된 AI 제공업체',
  diagTranslateProviders: '활성화된 번역 서비스',
  diagDebugTitle: '디버그 도구',
  diagDebugDesc: '더 깊이 있는 자가 진단이나 버그 리포트 첨부용입니다.',
  diagBtnLoadLogs: '최근 로그 불러오기',
  diagLogsEmpty: '아직 로그가 없습니다.',
  diagLogLevel: '로그 수준',
  diagLogLevelHint: '즉시 적용되며, 앱을 다음에 시작하면 기본값으로 돌아갑니다.',
  logLevelError: '오류',
  logLevelWarn: '경고',
  logLevelInfo: '정보',
  logLevelDebug: '디버그',
  logLevelTrace: '상세',
  diagBtnClearCaches: 'OCR 캐시 + 번역 쿨다운 지우기',
  diagClearCachesHint: '다음 호버 시 인식을 처음부터 다시 하고 모든 번역 서비스를 즉시 재시도하도록 합니다.',
  diagClearCachesDone: '지웠습니다.',
  diagBtnExportBundle: '디버그 번들 내보내기',
  diagExportBundleHint: '진단 정보, 설정, 최근 로그를 파일로 저장합니다 — API 키는 절대 포함하지 않습니다.',
